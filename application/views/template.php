...
<body class="page-header-fixed">
  ...
  <div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="navbar-inner">
      <div class="container-fluid">
        ...
        <img style="width: 200px; height: 40px;" src="<?php echo base_url();?>images/logo/logo.png" alt="logo" />
        </a>
        <!-- END LOGO -->
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="start active">
         ...
         <li >
          ...
          <ul class="sub-menu">
            <li>
              <a href="<?php echo base_url();?>adminweb/semua_pesanan">Daftar Pesanan</a>
            </li>
          </ul>
        </li>
        ...
        <li >
          ...
          <ul class="sub-menu">
             <li >
              <a href="<?php echo base_url();?>adminweb/toko">
              Toko</a>
            </li>
  ...
  <div class="footer">
    <div class="footer-inner">
      2019 &copy; Sistem Percetaka Online - Admin Dashboard.
    </div>
